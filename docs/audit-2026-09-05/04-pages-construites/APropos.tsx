...
/**
 * À propos — version construite par l'audit du 05/09/2026 (C-02).
 *
 * L'ancienne page disait bien le problème et la méthode, mais ne disait ni
 * QUI (aucun nom, aucune entité), ni DEPUIS QUAND, ni COMBIEN (aucun chiffre),
 * ni COMMENT Akora gagne sa vie. Une page de confiance sans ces quatre
 * réponses ne rassure personne qui s'apprête à payer 400 000 Ar par MVola.
 *
 * Les chiffres sont recomptés en base le 05/09/2026 et arrondis VERS LE BAS ;
 * ils se relisent avant chaque mise à jour de la page (règle : jamais un
 * chiffre annoncé sans l'avoir recompté). `[À COMPLÉTER]` : équipe, date.
 */
const CHIFFRES = [
  ...
  return (
    ...
    >
      ...
      <p>
        ...
        appelé cinq dépôts — et neuf annonces sur dix ne donnent pas leur prix : il faut téléphoner.
      </p>
      ...
      <p>
        ...
        briqueteries), avec les prix qu'ils ont publiés et leurs coordonnées. Ces fiches sont
        signalées comme telles ; le dépôt peut les revendiquer en une minute, les corriger ou les faire
        retirer. Un produit n'entre sur le site qu'avec une référence du catalogue, un prix et une
        photo — sinon il attend.
      </p>

      <h2>Qui</h2>
      <p>
        Akora est fait par l'équipe de <strong>Fonenako</strong>, la plateforme immobilière malgache
        (fonenako.mg), à Antananarivo : [À COMPLÉTER — prénom·s et rôle·s, ex. « Andry, fondateur,
        conducteur de travaux de formation »]. Même exigence, même refus des données inventées, même
        attention au réseau lent : la majorité de nos visiteurs sont sur un téléphone Android en 3G,
        et le site est conçu pour eux d'abord. Le projet est né en [À COMPLÉTER — mois année] ; le
        site est ouvert au public depuis [À COMPLÉTER — date de lancement].
      </p>
      <p>
        L'éditeur, ses identifiants légaux et l'hébergement sont dans les{" "}
